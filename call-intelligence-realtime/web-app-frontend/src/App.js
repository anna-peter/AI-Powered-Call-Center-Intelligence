      ...
      recognizer.recognized = async (s, e) => {
        if(e.result.reason === ResultReason.RecognizedSpeech){
           ...
           document.getElementById("transcriptTextarea").value = resultText;
            ...
            const nlpObj = await getGPT3CustomPromptCompletion(resultText);              
            this.setState({ displayNLPOutput: nlpObj.data.text }); 
      ...
      return (
          <Container className="app-container">
             <div class="card text-white bg-dark mb-3 text-center" >
                <h3 class="card-header">Insurance Intelligent Call Center Support</h3>
                <p> </p>                
